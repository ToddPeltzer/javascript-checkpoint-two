 ...
 */
  ...
  //   console.log(`${solarSystem[i].name} is beautiful`)
  // }
...
let nameArray = []
for(i=0; i<solarSystem.length; i++) {
  nameArray.push(solarSystem[i].name)
}
console.log(nameArray)

let array = solarSystem.map(item => item.name)
console.log(array)
...
// let array = solarSystem.filter(item => item.ringSystem == true)
// console.log(array)
