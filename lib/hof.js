...
// function beautifulPlanet(e) {
//   for (i = 0; i < e.length; i++) {
//     let planetName = e[i].name
//     console.log(`${planetName} is beautiful`);
//   }
// }

// beautifulPlanet(solarSystem);

/*
 * Create an array of all the planet names.
 */

// function planetNames(e) {
//   let nameArray = [];
//   for (i = 0; i < e.length; i++) {
//     nameArray.push(e[i].name);
//   }
//   console.log(nameArray)
// }

// planetNames(solarSystem);

/*
 * Create an array of planets that do have a ringSystem
 */

// function ringPlanets(e) {
//   let ringPlanetArray = [];
//   for (i = 0; i < e.length; i++) {
//     if(e[i].ringSystem == true) {
//       ringPlanetArray.push(e[i].name);
//     }
//   }
//   console.log(ringPlanetArray);
// }

// ringPlanets(solarSystem);


/*
 * Create an array of planets with 3 or more moons.
 */

// function multiMoon(e) {
//   let moonArray = [];
//   for (i = 0; i < e.length; i++) {
//     if(e[i].moons.length >= 3) {
//       moonArray.push(e[i].name)
//     }
//   }
//   console.log(moonArray);
// }

// multiMoon(solarSystem);
